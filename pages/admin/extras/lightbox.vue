...
export default {
    ...
    data() {
        return {
            ...
            index: 0, // default: 0
            imgs: [
                require("~/assets/admin/images/small/img-1.jpg"),
                require("~/assets/admin/images/small/img-2.jpg"),
                require("~/assets/admin/images/small/img-3.jpg"),
                require("~/assets/admin/images/small/img-4.jpg"),
                require("~/assets/admin/images/small/img-5.jpg"),
                require("~/assets/admin/images/small/img-6.jpg")
            ],
            captionimgs: [{
                    src: require("~/assets/admin/images/small/img-3.jpg"),
                    title: "Caption 1"
                },
                {
                    src: require("~/assets/admin/images/small/img-7.jpg"),
                    title: "Caption 2"
                }
            ]
        }
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="popup-gallery">
                        <img src="@/assets/admin/images/small/img-1.jpg" width="120" @click="singleImage = true" />
                        <vue-easy-lightbox :visible="singleImage" :imgs="require('@/assets/admin/images/small/img-1.jpg')" @hide="singleImage = false"></vue-easy-lightbox>
                    </div>
                </div>
            </div>
        </div>
