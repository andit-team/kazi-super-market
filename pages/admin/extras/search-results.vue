                ...
                <div class="card-body">
                    ...
                    <b-tabs nav-class="nav-bordered">
                        <b-tab active>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="search-item">
                                        <div class="media">
                                            <img class="d-flex mr-3 rounded-circle" src="~/assets/admin/images/users/avatar-1.jpg" alt="Generic placeholder image" height="54">
                                    ...
                                    <div class="search-item">
                                        ...
                                        <div class="">
                                            <img src="~/assets/admin/images/small/img-1.jpg" height="48" alt="image" />
                                            <img src="~/assets/admin/images/small/img-2.jpg" height="48" alt="image" />
                                            <img src="~/assets/admin/images/small/img-3.jpg" height="48" alt="image" />
                                            <img src="~/assets/admin/images/small/img-4.jpg" height="48" alt="image" />
                                        </div>
                                    </div> <!-- end search item -->
                        ...
                        <b-tab>
                            ...
                            <div class="search-item">
                                <div class="media">
                                    <img class="d-flex mr-3 rounded-circle" src="~/assets/admin/images/users/avatar-2.jpg" alt="Generic placeholder image" height="54">
                                    <div class="media-body">
                                        <h5 class="mt-0">
                            ...
                            <div class="search-item">
                                <div class="media">
                                    <img class="d-flex mr-3 rounded-circle" src="~/assets/admin/images/users/avatar-3.jpg" alt="Generic placeholder image" height="54">
                                    <div class="media-body">
                                        <h5 class="mt-0">
                            ...
                            <div class="search-item">
                                <div class="media">
                                    <img class="d-flex mr-3 rounded-circle" src="~/assets/admin/images/users/avatar-4.jpg" alt="Generic placeholder image" height="54">
                                    <div class="media-body">
                                        <h5 class="mt-0">
                            ...
                            <div class="search-item">
                                <div class="media">
                                    <img class="d-flex mr-3 rounded-circle" src="~/assets/admin/images/users/avatar-5.jpg" alt="Generic placeholder image" height="54">
                                    <div class="media-body">
                                        <h5 class="mt-0">
