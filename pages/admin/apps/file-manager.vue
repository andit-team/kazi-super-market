...
export default {
    ...
    data() {
        return {
            ...
            fileManagerData: [{
                    icon: require('~/assets/admin/images/file-icons/pdf.svg'),
                    name: 'Invoice-project.pdf',
                    date: '17-Jan-18 2:55 PM',
                    size: '2.31 MB',
                    users: [require('~/assets/admin/images/users/avatar-4.jpg'), require('~/assets/admin/images/users/avatar-6.jpg')]
                },
                {
                    icon: require('~/assets/admin/images/file-icons/png.svg'),
                    name: 'Dashboard-design.png',
                    date: '21-May-18 1:12 PM',
                    size: '3.89 MB',
                    users: [require('~/assets/admin/images/users/avatar-5.jpg')]
                },
                {
                    icon: require('~/assets/admin/images/file-icons/psd.svg'),
                    name: 'Graphic-logo-main.psd',
                    date: '23-May-18 11:34 AM',
                    size: '125 MB',
                    users: [require('~/assets/admin/images/users/avatar-1.jpg'), require('~/assets/admin/images/users/avatar-2.jpg'), require('~/assets/admin/images/users/avatar-3.jpg')]
                },
                {
                    icon: require('~/assets/admin/images/file-icons/avi.svg'),
                    name: 'Audio-video-file.avi',
                    date: '18-Feb-18 4:29 PM',
                    size: '12.3 MB',
                    users: [require('~/assets/admin/images/users/avatar-7.jpg'), require('~/assets/admin/images/users/avatar-8.jpg')]
                },
                {
                    icon: require('~/assets/admin/images/file-icons/pdf.svg'),
                    ...
                    size: '256 KB',
                    users: [require('~/assets/admin/images/users/avatar-6.jpg')]
                },
                {
                    icon: require('~/assets/admin/images/file-icons/txt.svg'),
                    name: 'File-changes-notes.txt',
                    date: '17-Jan-18 2:55 PM',
                    size: '57.3 MB',
                    users: [require('~/assets/admin/images/users/avatar-9.jpg'), require('~/assets/admin/images/users/avatar-10.jpg')]
                },
                {
                    icon: require('~/assets/admin/images/file-icons/eps.svg'),
                    name: 'Eps-file-formate.eps',
                    date: '21-Jun-18 1:12 PM',
                    size: '429 MB',
                    users: [require('~/assets/admin/images/users/avatar-1.jpg'), require('~/assets/admin/images/users/avatar-2.jpg')]
                },
                {
                    icon: require('~/assets/admin/images/file-icons/dll.svg'),
                    name: 'Software-activation.dll',
                    date: '23-May-18 11:34 AM',
                    size: '58 KB',
                    users: [require('~/assets/admin/images/users/avatar-3.jpg')]
                },
                {
                    icon: require('~/assets/admin/images/file-icons/sql.svg'),
        ...
        saveFile(event) {
            for (let i = 0; i < event.target.files.length; i++) {
                ...
                this.fileManagerData.push({
                    ...
                    date,
                    size,
                    users: [require('~/assets/admin/images/users/avatar-1.jpg')],
                })
            }
        },
    },
