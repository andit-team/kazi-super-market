            ...
            <div class="card">
                <div class="card-body">
                    <div class="media mb-3">
                        <img src="~/assets/admin/images/users/avatar-1.jpg" class="mr-2 rounded-circle" height="42" alt="Brandon Smith" />
            ...
            <div class="card">
                <div class="card-body py-2 px-3 border-bottom border-light">
                    <div class="media py-1">
                        <img src="~/assets/admin/images/users/avatar-5.jpg" class="mr-2 rounded-circle" height="36" alt="Brandon Smith" />
                        <div class="media-body">
                            <h5 class="mt-0 mb-0 font-15">
