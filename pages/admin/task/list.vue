                                            ...
                                            <table class="table table-centered table-nowrap table-borderless table-sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="~/assets/admin/images/users/avatar-2.jpg" lt="image" class="avatar-sm img-thumbnail rounded-circle" v-b-tooltip.hover title="Houston Fritz" />
                                                            </div>
                                                        </td>
                                                        <td>Today 10am</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="~/assets/admin/images/users/avatar-3.jpg" lt="image" class="avatar-sm img-thumbnail rounded-circle" v-b-tooltip.hover title="Glenn Lynch" />
                                                            </div>
                                                        </td>
                                                        <td>Today 04pm</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="~/assets/admin/images/users/avatar-4.jpg" lt="image" class="avatar-sm img-thumbnail rounded-circle" v-b-tooltip.hover title="Robert Hebert" />
                                                            </div>
                                                        </td>
                                                        <td>Today 02pm</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="~/assets/admin/images/users/avatar-5.jpg" lt="image" class="avatar-sm img-thumbnail rounded-circle" v-b-tooltip.hover title="Darnell McCormick" />
                                                            </div>
                                                        </td>
                                                        <td>Today 06pm</td>
                                                        <td>
                                            ...
                                            <table class="table table-centered table-nowrap table-borderless table-sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="~/assets/admin/images/users/avatar-5.jpg" lt="image" class="avatar-sm img-thumbnail rounded-circle" v-b-tooltip.hover title="Donald Mealy" />
                                                            </div>
                                                        </td>
                                                        <td>May 27, 2020</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="~/assets/admin/images/users/avatar-6.jpg" lt="image" class="avatar-sm img-thumbnail rounded-circle" v-b-tooltip.hover title="Shelton Garza" />
                                                            </div>
                                                        </td>
                                                        <td>No Due Date</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="~/assets/admin/images/users/avatar-7.jpg" lt="image" class="avatar-sm img-thumbnail rounded-circle" v-b-tooltip.hover title="Adrian Key" />
                                                            </div>
                                                        </td>
                                                        <td>June 08, 2020</td>
                                                        <td>
                                            ...
                                            <table class="table table-centered table-nowrap table-borderless table-sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="~/assets/admin/images/users/avatar-9.jpg" lt="image" class="avatar-sm img-thumbnail rounded-circle" v-b-tooltip.hover title="Donald Mealy" />
                                                            </div>
                                                        </td>
                                                        <td>June 04, 2020</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="~/assets/admin/images/users/avatar-10.jpg" lt="image" class="avatar-sm img-thumbnail rounded-circle" v-b-tooltip.hover title="Doris Kinsey" />
                                                            </div>
                                                        </td>
                                                        <td>June 10, 2020</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="~/assets/admin/images/users/avatar-2.jpg" lt="image" class="avatar-sm img-thumbnail rounded-circle" v-b-tooltip.hover title="Donnell Smith" />
                                                            </div>
                                                        </td>
                                                        <td>No Due Date</td>
                                                        <td>
