                    ...
                    <div class="text-muted">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="media mt-3">
                                    <div class="mr-2 align-self-center">
                                        <img src="~/assets/admin/images/users/avatar-2.jpg" alt class="avatar-sm rounded-circle" />
                                    </div>
                                    <div class="media-body overflow-hidden">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="media">
                        <img class="mr-2 rounded-circle" src="~/assets/admin/images/users/avatar-3.jpg" alt="Generic placeholder image" height="32" />
                        <div class="media-body">
                            ...
                            <div class="media mt-3">
                                <a class="pr-2" href="#">
                                    <img src="~/assets/admin/images/users/avatar-4.jpg" class="rounded-circle" alt="Generic placeholder image" height="32" />
                                </a>
                                <div class="media-body">
                                    <h5 class="mt-0">
                                        Louis Hill
                    ...
                    <div class="media mt-3">
                        <img class="mr-2 rounded-circle" src="~/assets/admin/images/users/avatar-5.jpg" alt="Generic placeholder image" height="32" />
                        <div class="media-body">
                            <h5 class="mt-0">
                                Aaron Wilson
