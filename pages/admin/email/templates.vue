                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a target="_blank">
                                <img src="~/assets/admin/images/email/1.png" class="img-fluid" alt="" />
                            </a>
                        </div>
                        <div class="col-md-4">
                            <h4 class="header-title my-3 mt-md-0">Email alert</h4>
                            <a target="_blank">
                                <img src="~/assets/admin/images/email/2.png" class="img-fluid" alt="" />
                            </a>
                        </div>
                        <div class="col-md-4">
                            <h4 class="header-title my-3 mt-md-0">Billing email</h4>
                            <a target="_blank">
                                <img src="~/assets/admin/images/email/3.png" class="img-fluid" alt="" />
                            </a>
                        </div>
                    </div>
                    <!-- end row-->
