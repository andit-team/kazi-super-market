                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-nowrap mb-0">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 80px;">
                                                        <img src="~/assets/admin/images/products/product-1.png" alt="product-img" title="product-img" class="rounded" height="48" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="~/assets/admin/images/products/product-6.png" alt="product-img" title="product-img" class="rounded" height="48" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="~/assets/admin/images/products/product-8.png" alt="product-img" title="product-img" class="rounded mr-2" height="48" />
                                                    </td>
                                                    <td>
