                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center">
                                                            <div class="mr-3">
                                                                <img src="~/assets/admin/images/products/product-1.png" alt="product-img" height="40" />
                                                            </div>
                                                            <div class="media-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center">
                                                            <div class="mr-3">
                                                                <img src="~/assets/admin/images/products/product-6.png" alt="product-img" height="40" />
                                                            </div>
                                                            <div class="media-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center">
                                                            <div class="mr-3">
                                                                <img src="~/assets/admin/images/products/product-8.png" alt="product-img" height="40" />
                                                            </div>
                                                            <div class="media-body">
