...
<div>
    ...
    <div class="row">
        <div class="col-lg-6 col-xl-3">
            <!-- Simple card -->
            <b-card :img-src="require('~/assets/admin/images/small/img-1.jpg')" img-alt="Card image" img-top>
                <b-card-title>
        ...
        <div class="col-lg-6 col-xl-3">
            <b-card no-body :img-src="require('~/assets/admin/images/small/img-2.jpg')" img-alt="Card image" img-top>
                <b-card-body>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
        ...
        <div class="col-lg-6 col-xl-3">
            <b-card :img-src="require('~/assets/admin/images/small/img-3.jpg')" img-alt="Card image" img-top>
                <b-card-text>
                    Some quick example text to build on the card title and make up the bulk of the card's content. With supporting text below as a natural lead-in to additional content.
                </b-card-text>
                <b-button href="javascript:void(0);" variant="primary">Button</b-button>
        ...
        <div class="col-lg-6 col-xl-3">
            <b-card no-body>
                ...
                <img src="~/assets/admin/images/small/img-4.jpg" class="img-fluid" />
                <b-card-body>
                    <b-card-text>
    ...
    <div class="row">
        <div class="col-md-4">
            <b-card :img-src="require('~/assets/admin/images/small/img-5.jpg')" img-alt="Card image" img-top>
                <b-card-title>
                    <h5 class="card-title">Card title</h5>
                </b-card-title>
                <b-card-text>
        ...
        <div class="col-md-4">
            <b-card :img-src="require('~/assets/admin/images/small/img-6.jpg')" img-alt="Card image" img-bottom>
                <b-card-title>
                    <h5 class="card-title">Card title</h5>
                </b-card-title>
                <b-card-text>
        ...
        <div class="col-md-4">
            <b-card overlay :img-src="require('~/assets/admin/images/small/img-7.jpg')" img-alt="Card Image" text-variant="white">
                <b-card-title>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <b-card-group>
                ...
                <b-card :img-src="require('~/assets/admin/images/small/img-2.jpg')" img-alt="Card image" img-top>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                    <b-card-text>
    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <b-card-group deck>
                <b-card :img-src="require('~/assets/admin/images/small/img-4.jpg')" img-alt="Card image" img-top>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                    <b-card-text>
                ...
                <b-card :img-src="require('~/assets/admin/images/small/img-6.jpg')" img-alt="Card image" img-top>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                    <b-card-text>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <b-card-group columns>
                <b-card :img-src="require('~/assets/admin/images/small/img-7.jpg')" img-alt="Image" img-top>
                    <b-card-title>
                ...
                <b-card :img-src="require('~/assets/admin/images/small/img-1.jpg')" img-alt="Image" img-top>
                    <b-card-title>
                        <h5 class="card-title">Card title</h5>
                    </b-card-title>
                ...
                <b-card :img-src="require('~/assets/admin/images/small/img-2.jpg')" img-alt="Image" overlay></b-card>
