                          ...
                          <div class="col-sm-12 col-md-6">
                              <div id="tickets-table_length" class="dataTables_length">
                                  <label class="d-inline-flex align-items-center">
                                      Show:
                                      <b-form-select v-model="perPage" size="lg" :options="pageOptions" class="rounded-0 ml-2"></b-form-select>&nbsp;entries
                                  </label>
                              </div>
                          </div>
                          <!-- Search -->
                          <div class="col-sm-12 col-md-6">
                              <div id="tickets-table_filter" class="dataTables_filter text-md-right mb-2 mb-md-0 mb-lg-0">
                                  <label class="d-inline-flex align-items-center">
                                      Search:
