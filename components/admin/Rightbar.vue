                    ...
                    <div class="p-2">
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-2">
                                    ...
                                    <img src="~/assets/admin/images/users/avatar-10.jpg" class="rounded-circle avatar-sm" alt="user-pic" />
                                </div>
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-2">
                                    <span class="user-status"></span>
                                    <img src="~/assets/admin/images/users/avatar-1.jpg" class="rounded-circle avatar-sm" alt="user-pic" />
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-2">
                                    ...
                                    <img src="~/assets/admin/images/users/avatar-9.jpg" class="rounded-circle avatar-sm" alt="user-pic" />
                                </div>
                                <div class="media-body overflow-hidden">
                    ...
                    <div class="p-2 pb-4">
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-2">
                                    ...
                                    <img src="~/assets/admin/images/users/avatar-2.jpg" class="rounded-circle avatar-sm" alt="user-pic" />
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-2">
                                    ...
                                    <img src="~/assets/admin/images/users/avatar-4.jpg" class="rounded-circle avatar-sm" alt="user-pic" />
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-2">
                                    <span class="user-status online"></span>
                                    <img src="~/assets/admin/images/users/avatar-5.jpg" class="rounded-circle avatar-sm" alt="user-pic" />
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-2">
                                    <span class="user-status busy"></span>
                                    <img src="~/assets/admin/images/users/avatar-7.jpg" class="rounded-circle avatar-sm" alt="user-pic" />
                                </div>
                                <div class="media-body overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="media">
                                <div class="position-relative mr-2">
                                    <span class="user-status away"></span>
                                    <img src="~/assets/admin/images/users/avatar-8.jpg" class="rounded-circle avatar-sm" alt="user-pic" />
                                </div>
                                <div class="media-body overflow-hidden">
