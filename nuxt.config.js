export default {
  ...
  ** Global CSS
  */
  css: ["~/assets/admin/scss/app.scss", 'quill/dist/quill.core.css', 'quill/dist/quill.snow.css', 'quill/dist/quill.bubble.css','@/assets/scss/app.scss','swiper/dist/css/swiper.css'],
  /*
